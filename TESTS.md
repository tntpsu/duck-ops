...
**STATUS: SPEC-ONLY 2026-07-11 (corrected after live probe).** Not implemented. Bridge DONE: 5 recent 5★ replies hand-posted this session (tx 5123597926, 5121094714 via executor ~13:00; tx 5110921538/5123940388/5118254996 via direct-DOM, operator-approved, ~15:35) — 16 posted / 12 queued. Root cause corrected: PRIMARY is the executor locate/navigation bug (rows present on page 1 fail), not buried rows. P1 (fix 0 locate reliability) next session, P2–P3 after, P4 on operator sign-off.
