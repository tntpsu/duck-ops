...
| Known gap | — | — | — | — | surface graphics that the generator did NOT split into parts print in the part color (the Ranger's eye slits are relief on the helmet); next layer: per-part texture projection or a `pattern` split |
